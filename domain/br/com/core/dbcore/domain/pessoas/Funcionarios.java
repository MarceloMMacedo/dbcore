...
public class Funcionarios
	...
	public List<EnderecoFuncionarios> getEnderecos() {
		return enderecos;
	}

	@Override
	public void setEnderecos(List<EnderecoFuncionarios> enderecos) {
		this.enderecos = enderecos;
	}

	public List<ContasBancFuncionarios> getContasBancarias() {
		return contasBancarias;
	}

	public void setContasBancarias(List<ContasBancFuncionarios> contasBancarias) {
		this.contasBancarias = contasBancarias;
	}

	public List<ContacFuncionarios> getContatos() {
		return contatos;
	}

	public void setContatos(List<ContacFuncionarios> contatos) {
	...
	@Override
	public EnderecoFuncionarios getEnderecoPrincipal() {
		return enderecoPrincipal;
	}

	public void setEnderecoPrincipal(EnderecoFuncionarios enderecoPrincipal) {
	...
	@Override
	public ContacFuncionarios getContatoPrincipal() {
		return contatoPrincipal;
	}

	public void setContatoPrincipal(ContacFuncionarios contatoPrincipal) {
